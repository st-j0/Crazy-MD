...
cmd({
        ...
        async(Void, citel, text,{ isCreator }) => {
            ...
            if (!text.split(" ")[0] && !text.split(" ")[0].includes("whatsapp.com"))
                citel.reply("Lien Invalide, Envoyez un lien Whatsapp valide!");
            let result = text.split(" ")[0].split("https://chat.whatsapp.com/")[1];
            await Void.groupAcceptInvite(result)
                .then((res) => citel.reply("🟩Groupe rejoins"))
                .catch((err) => citel.reply("Error 404 en intégrant le groupe"));
...
cmd({
        ...
        async(Void, citel, text) => {
            if (!citel.quoted) return citel.reply(`*Taggez une image/video Mr.*`);
            let mime = citel.quoted.mtype
            pack = Config.packname
            author = Config.author
            if (citel.quoted) {
                let media = await citel.quoted.download();
                citel.reply("*Patientez Svp !⌛*");
                ...
                if ((quoted.msg || citel.quoted)
                    .seconds > 20) return citel.reply("Impossible de chercher une vidéo > *20 Secondes*");
                ...
                citel.reply("*Taggez une image/video Mr*");
            }
        }
    )
    //---------------------------------------------------------------------------
cmd({
    ...
    async(Void, citel, text) => {
        citel.reply(`*Regarde Dm ${tlang().greet}*`);
        await Void.sendMessage(`${citel.sender}`, {
            image: log0,
            caption: `*Group Name: CRAZY-MD*\n*Group Link:* https://chat.whatsapp.com/CLTULUN0HQh9Ocp7RjEZG1`,
        });
...
cmd({
        ...
        async(Void, citel, text,{ isCreator }) => {
            ...
            if (!isAdmins) return citel.reply('Commande reservée uniquement aux admins.')
...
cmd({
        ...
        async(Void, citel, text,{ isCreator }) => {
            ...
            if (!citel.quoted) return citel.reply("Taggez un membre");
    ...
    let textt = `_Voici les adresses jid de tous les membres de_\n *- ${groupMetadata.subject}*\n\n`
...
cmd({
    ...
    citel.sender.split("@")[0]
            ...
            teks2 = `\n\n*Hii ${pushname},Votre requete a été envoyée à CRAZY_PRINCE*.\n*Patientez Svp.......*`;
            for (let i of owner) {
...
cmd({
        ...
        async(Void, citel, text) => {
            if (!citel.quoted) return reply("Veuillez tagger une image/video!");
            let mime = citel.quoted.mtype
            if (/viewOnce/.test(mime)) {
                ...
                await citel.reply("Veuillez tagger une vue unique");
            }
        }
    )
    //---------------------------------------------------------------------------
cmd({
        ...
        async(Void, citel, text,{isCreator}) => {
            if (!isCreator) return citel.reply(tlang().owner)
            if (!citel.quoted) return citel.reply('Mentionnez un utilisateur avertis.')
            await warndb.deleteOne({ id: citel.quoted.sender.split('@')[0] + 'warn' });
            return citel.reply('@user est désormais libre comme une fille de barrière le 25/12.\n.')
        }
    )
    //---------------------------------------------------------------------------
cmd({
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (text.split(" ")[0] === "close") {
                ...
                return citel.reply(`Group Mode:\n${prefix}group open- pour ouvrir\n${prefix}group close- pour fermer`);
            }
        }
    )
    //---------------------------------------------------------------------------
cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (!citel.quoted) return citel.reply(`Envoyez ou taggez une légende ${command}`);
            if (!/image/.test(mime)) return citel.reply(`Envoyez ou taggez une image avec légende ${command}`);
            if (/webp/.test(mime)) return citel.reply(`Envoyez ou taggez une image avec légende ${command}`);
...
cmd({
        ...
        async(Void, citel, text,{isCreator}) => {
            ...
            if (!text) return citel.reply("Veuillez me fournir un numéro.");
            if (!isCreator) return citel.reply(tlang().owner)
            if (!isBotAdmins) return citel.reply(tlang().botAdmin);
            let users = citel.mentionedJid[0] ? citel.mentionedJid[0] : citel.quoted ? citel.quoted.sender : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
...
cmd({
        ...
        async(Void, citel, text,{ isCreator }) => {
            ...
            let jackhuh = `jid de tout le Groupe\n\n`
            citel.reply(`Recherche des jid dans ${anu.length} Groupes`)
            for (let i of anu) {
                let metadata = await Void.groupMetadata(i);
                await sleep(500)
                jackhuh += `*Sujet:-* ${metadata.subject}\n`
                jackhuh += `*Membres :* ${metadata.participants.length}\n`
                jackhuh += `*Jid:-* ${i}\n\n`
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            if (!citel.quoted.isBot) {
                ...
                const isBotAdmins = citel.isGroup ? groupAdmins.includes(botNumber) : false;
                const isAdmins = citel.isGroup ? groupAdmins.includes(citel.sender) : false;
                if (!isAdmins) return citel.reply('Seuls les administrateurs sont autorisés à supprimer les messages d\'autres personnes.')
                if (!isBotAdmins) return citel.reply('Je ne peux supprimer le message de personne sans obtenir le rôle d\'administrateur.')
                if (!citel.quoted) return citel.reply(`Veuillez tagger un message. ${tlang().greet}`);
...
cmd({
        ...
        async(Void, citel, text) => {
            if (!citel.isGroup) return citel.reply('Cette commande est uniquement pour le groupe.')
            if (!citel.quoted) return citel.reply('Citer un utilisateur maître.')
            teskd = `*All Warnings.*\n\n`
            ...
            for (let i = 0; i < h.length; i++) {
                teskd += `*${i+1}*\n╭─────────────◆\n│ *🍁In Group:-* ${h[i].group}\n`
                teskd += `│ *🔰Date:-* ${h[i].date}\n`
                teskd += `│ *⚠️Avertis par:-* ${h[i].warnedby}\n`
                teskd += `│ _📍Raison: ${h[i].reason}_\n╰─────────────◆\n\n`
            }
            citel.reply(teskd)
        }
...
cmd({
        ...
        async(Void, citel, text) => {
            if (!citel.quoted) return citel.reply("Veuillez mentionner un membre");
            if (!isCreator) citel.reply(tlang().owner);
            let users = citel.mentionedJid[0] ? citel.mentionedJid[0] : citel.quoted ? citel.quoted.sender : text.replace(/[^0-9]/g, "") + "@s.whatsapp.net";
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        let groups = Object.entries(getGroups)
            ...
            .map((entry) => entry[1]);
        let anu = groups.map((v) => v.id);
        citel.reply(`Envoyer un Broadcast au groupe ${anu.length} , Durée ${
          anu.length * 1.5
        } second`);
        for (let i of anu) {
            await sleep(1500);
            let txt = `*--❗${tlang().title} Broadcast❗--*\n\n *🍀Auteur:* ${citel.pushName}\n\n${text}`;
            let buttonMessaged = {
                image: log0,
                caption: txt,
        ...
        citel.reply(`*Broadcast envoyée avec succès à ${anu.length} Groupe(s)*`);
    }
)
